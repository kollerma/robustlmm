...
/* Karl Broman changed R_* to Rqtl_*, to avoid potential conflicts with R */
    ...
    int *Maxit)				/* Max # of iterations */
{
    double fa = (*f)(ax, info);
    double fb = (*f)(bx, info);
    return Rrlmm_zeroin2(ax, bx, fa, fb, f, info, Tol, Maxit);
}

/* Rqtl_zeroin2() is faster for "expensive" f(), in those typical cases where
