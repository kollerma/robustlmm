...
Development of \pkg{robustlmm} is hosted on GitHub at \url{https://www.github.com/kollerma/robustlmm}. Any issues with the package can also be reported there.
