...
The function \code{modelMatrix} from \pkg{MatrixModels}
\citep{MatrixModels} is used to create the model matrix in
\code{generateAnovaDatasets}. The function \code{hubers} from \pkg{MASS}
